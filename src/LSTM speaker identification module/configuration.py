...
data_arg.add_argument('--train_path', type=str, default='./LSTM speaker identification module/train_tisv', help="train dataset directory")
data_arg.add_argument('--audio_path', type=str, default='/home/nina/Dev/insight/speech_data/speech-accent-archive/recordings', help="full length audio directory")
data_arg.add_argument('--test_path', type=str, default='./LSTM speaker identification module/test_tisv', help="test dataset directory")
data_arg.add_argument('--utterance_length', type=int, default=8000, help="length of utterance in ")
...
model_arg.add_argument('--model_path', type=str, default='/home/nina/Dev/insight/Speaker-Identification/src/LSTM speaker identification module/tisv_model', help="model directory to save or load")
model_arg.add_argument('--model_num', type=int, default=7, help="number of ckpt file to load")
